...
import { Check, FileText, Edit3, Download } from "lucide-react";
...
export default async function TemplateLandingPage({ params }: TemplatePageProps) {
    ...
    const cleanName = template.name.replace(/\s*Receipt\s*/gi, '').trim();
    const templateSlug = generateTemplateSlug(template.name);
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                    ...
                    <div className="space-y-4 sm:space-y-6 text-center lg:text-left">
                        <h1 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-900 dark:text-white leading-tight">
                            Free {cleanName} Receipt Generator
                        </h1>
                        <p className="text-sm sm:text-base lg:text-lg text-gray-600 dark:text-gray-400 max-w-xl mx-auto lg:mx-0">
                            Need a {cleanName} receipt? Use our free tool to generate a detailed purchase record. Add store info, items bought, prices, tax, and payment—perfect for returns, warranties, or expense tracking.
                        </p>
                        ...
                        <div className="bg-blue-50 dark:bg-blue-900/20 rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 flex flex-col sm:flex-row gap-4 sm:gap-6 items-center">
                            ...
                            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
                                {template.thumbnail ? (
                                    ...
                                    <div className="w-[180px] sm:w-[200px] lg:w-[260px] h-[260px] sm:h-[280px] lg:h-[320px] flex items-center justify-center text-gray-400">
            ...
            <section className="container mx-auto px-4 sm:px-6 py-10 sm:py-16">
                <div className="text-center mb-8 sm:mb-12">
                    ...
                    <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mt-2">
                        How to make a {cleanName} Receipt?
                    </h2>
